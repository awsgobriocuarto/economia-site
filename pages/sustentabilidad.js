        ...
        <div className='container'>
          <div className='row gx-5 justify-content-between'>
            ...
            <div className='col-md-6'>
              ...
              <a className='btn btn-secondary' target='_blank' rel='noopener noreferrer' href="https://unglobalcompact.org/what-is-gc/participants/152105-Municipalidad-de-R-o-Cuarto">VER REPORTE</a>
            </div>
          </div>
        </div>
      </div>
