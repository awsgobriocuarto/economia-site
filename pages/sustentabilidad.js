  ...
  return (
    <>
      ...
      <Header
        ...
        subtitle="Río Cuarto hacia un Modelo Sustentable"
      />
      <div className="pages">
        <div className="container">
          <div className="row gx-5 justify-content-between">
            ...
            <div className="col-md-6">
              <h2>Río Cuarto hacia un modelo sustentable</h2>
              <p className="lead">
                La Municipalidad de Río Cuarto presentó su primer Reporte de
                Sustentabilidad, que abarca las iniciativas emprendidas por el
                gobierno local en el período comprendido entre el 1 de enero de
                2022 y el 31 de diciembre de 2022.
              </p>
              <p>
                Este informe representa un hito importante en el camino de
                nuestra ciudad hacia un modelo más sustentable y resalta el
                compromiso del municipio con el desarrollo sostenible en todas
                las áreas de gobierno.
              </p>
              <p>
                El Reporte de Sustentabilidad de la Municipalidad de Río Cuarto
                es un documento integral que proporciona una visión transparente
                y detallada de las acciones y logros alcanzados en materia de
                sustentabilidad durante el último año. Este informe refleja el
                compromiso de mantener una gestión responsable y equilibrada,
                teniendo en cuenta los aspectos económicos, sociales y
                ambientales que impactan en nuestra comunidad.
              </p>
              <p>
                Fue elaborado a través del ente de indicadores reconocidos a
                nivel internacional como lo son los Estándares GRI. Además, en
                el documento se detalla la contribución del municipio al logro
                de los Objetivos de Desarrollo Sostenible así como el aporte a
                los 10 Principios del Pacto Global de Naciones Unidas que giran
                en torno a los derechos humanos, las normas laborales, el
                medioambiente y la anticorrupción.{" "}
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://unglobalcompact.org/what-is-gc/participants/152105-Municipalidad-de-R-o-Cuarto"
                >
                  unglobalcompact.org
                </a>
              </p>
              ...
              <p>
                A lo largo de las páginas del reporte, se podrá conocer la
                importancia que el desarrollo sostenible representa para la
                agenda de gobierno municipal. Asimismo, podrán interiorizarse en
                las acciones desarrolladas y los resultados obtenidos en el
                marco de los ejes estratégicos del municipio: participación
                ciudadana; transparencia, calidad e innovación; desarrollo local
                sostenible; y justicia social.
              </p>
              <p>
                El reporte de sustentabilidad completo se encuentra disponible
              ...
              <p>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://drive.google.com/file/d/1zKIetYcmYuSkLq287pHbq73jvaPi83qr/view?usp=sharing"
                >
                  VER REPORTE
                </a>
              </p>
